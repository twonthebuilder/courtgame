 ...
 */
const TAGLINES = [
  'An LLM-adjudicated legal game.',
  'Every case is unique.',
  'Procedural trials, real consequences.',
  'Strategy, rhetoric, and a skeptical bench.',
];
...
const MainMenu = ({ onPlay }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center p-6 animate-in fade-in zoom-in duration-500">
      ...
      <p className="text-slate-500 mb-10 text-lg font-medium max-w-md">
