...
- With-prejudice dismissals now auto-log misconduct warning entries that escalate clean counsel to warned and warned counsel to sanctioned.
- Without-prejudice dismissals do not create sanctions entries.
